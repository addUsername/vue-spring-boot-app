...
/*	
	@GetMapping("/api/ini")
	public String iniciate() {
		String lore = "bgfbfbpassages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum";
		...
		specs1.add(new Spec("almacenamiento", "32GB", 32.0));
		specs1.add(new Spec("chipset", "ARM 4-core", 0.99));
		specs1.add(new Spec("camera frontal", "good quality niggi, 8mp", 8.0));
		
		Phone uno = new Phone("jsnbjs-",one,specs);
		Phone tres = new Phone("v8",three,specs1);
		Phone cuatro = new Phone("nome",four,specs1);
		Phone cinco = new Phone("vdds8",five ,specs1);
		Phone seis = new Phone("xiaomi-mi-10-youth-5g-.jpg",six ,specs1);
		Phone siete = new Phone("vsds  sd8",seven ,specs1);
		Phone ocho = new Phone("v8sds ds",eigth ,specs1);
		Phone nueve = new Phone("vss 8",nine ,specs1);
		Phone diez = new Phone("vddd8",ten ,specs1);
		Phone once = new Phone("v8ssss",eleven ,specs1);
		Phone doce  = new Phone("v8sddd", twelve,specs1);
		
		List<Spec> specs11 = new ArrayList<>();
		specs11.add(new Spec("almacenamiento", "16GB", 16.0));
		specs11.add(new Spec("chipset", "intel pepino", 0.99));
		specs11.add(new Spec("otros", "divable", 1.0));
		Phone dos = new Phone("holaa",two, specs11);
		
		this.phoneRepository.save(uno);
		this.phoneRepository.save(dos);	
		this.phoneRepository.save(tres);
		this.phoneRepository.save(cuatro);
		this.phoneRepository.save(cinco);
		this.phoneRepository.save(seis);
		this.phoneRepository.save(siete);
		this.phoneRepository.save(ocho);
		this.phoneRepository.save(nueve);
		this.phoneRepository.save(diez);
		this.phoneRepository.save(once);
		this.phoneRepository.save(doce);

		Phone unouno = new Phone("xiaomi-mi-9-pro.jpg",six ,specs1);
		Phone unodos = new Phone("xiaomi-mi-cc9-pro-.jpg",six ,specs1);
		Phone unotres = new Phone("xiaomi-mi-note10-.jpg",six ,specs1);
		Phone unocuatro = new Phone("xiaomi-mi-watch-.jpg",six ,specs1);
		Phone unocinco = new Phone("xiaomi-poco-x2.jpg",six ,specs1);
		Phone unoseis = new Phone("xiaomi-redmi-10x-5g.jpg",six ,specs1);
		Phone unosiete = new Phone("xiaomi-redmi-8a.jpg",six ,specs1);
		Phone  unoocho= new Phone("xiaomi-redmi-9.jpg",six ,specs1);
		Phone  unonueve= new Phone("xiaomi-redmi-9c.jpg",six ,specs1);
		Phone  unodiez= new Phone("xiaomi-redmi-k30-5g.jpg",six ,specs1);
		Phone  unodoce= new Phone("xiaomi-redmi-k30i-5g-.jpg",six ,specs1);
		Phone  unotrece= new Phone("xiaomi-redmi-k30-pro.jpg",six ,specs1);
		Phone  unocatorce= new Phone("xiaomi-redmi-note-8t.jpg",six ,specs1);
		Phone  unoquince = new Phone("xiaomi-watch-color-.jpg",six ,specs1);
